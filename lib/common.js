...
PaymentProtocol.PAYMENT_REQUEST_CONTENT_TYPE = 'application/zelcash-paymentrequest';
PaymentProtocol.PAYMENT_CONTENT_TYPE = 'application/zelcash-payment';
PaymentProtocol.PAYMENT_ACK_CONTENT_TYPE = 'application/zelcash-paymentack';
...
function magicHash(str) {
  var magicBytes = new Buffer('Zelcash Signed Message:\n');
