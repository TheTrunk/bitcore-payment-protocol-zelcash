...
```sh
git clone https://github.com/TheTrunk/bitcore-payment-protocol-zelcash.git
cd bitcore-payment-protocol-zelcash
npm install
```
...
```javascript
var PaymentProtocol = require('bitcore-payment-protocol-zelcash');
